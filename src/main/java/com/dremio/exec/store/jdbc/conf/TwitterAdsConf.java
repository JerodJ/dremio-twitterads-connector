...
@SourceType(value = "TwitterAdsARP", label = "TwitterAds",uiConfig = "twitterads-layout.json")
public class TwitterAdsConf extends AbstractArpConf<TwitterAdsConf> {
  private static final String ARP_FILENAME = "arp/implementation/twitterads-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.twitterads.TwitterAdsDriver";
